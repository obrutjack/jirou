...
**Crew memory-store bindings**: explicitly created members receive an exclusive
private V2 store. Discovery sync registers ordinary agents with Global V1 and
leaves existing bindings unchanged. Valid existing V1 bindings remain usable until the owner explicitly opts
