...
class AgentConfig:
    ...
    provider: str = field(
        default="acp",
        metadata=_meta("Provider", "LLM provider backend. \"acp\" = kiro-cli (default); \"openai-compatible\" = any OpenAI-compatible endpoint (LM Studio, Ollama, BYOK).", enum=["acp", "local-llm"]),
    )
